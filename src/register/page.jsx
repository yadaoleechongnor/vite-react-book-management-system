      ...
      <div className="flex border h-auto gap-8 shadow-xl rounded-lg md:flex">
        ...
        <div className="md:flex flex-col items-center rounded-r-2xl bg-sky-300 justify-center border md:w-1/2 hidden">
          ...
          <div className="flex flex-col items-center p-6">
            <h1 className="text-3xl mb-2 font-bold">{t('register.title')}</h1>
            <p className="text-lg">{t('register.subtitle')}</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6">
          <div className="w-full max-w-sm">
            ...
            <h2 className="text-xl font-bold mb-4 text-center">{t('register.formTitle')}</h2>
                  ...
                  {Array.isArray(branches) && branches.length > 0 ? (
                    branches.map((branch) => (
                      <option key={branch._id} value={branch._id}>
                        {branch.name || branch.subject_department_name || branch.branch_name || t('register.unnamedBranch')}
                      </option>
                    ))
                  ) : (
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={t('register.studentCodePlaceholder')}
                    onInput={(e) => {
                      e.target.value = e.target.value.replace(/[^0-9]/g, '').slice(0, 10);
                    }}
                  />
